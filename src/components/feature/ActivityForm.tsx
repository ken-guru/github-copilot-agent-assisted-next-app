    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit} aria-label="Activity Form">
      {isSimplified ? (
        <Form.Group className="mb-0">
          <Form.Label visuallyHidden htmlFor="activityNameInput">Name</Form.Label>
            ...
            <div className="w-100">
              <div className="input-group">
                ...
                <Button
                  ...
                  variant="primary"
                  disabled={isDisabled}
                  data-testid="activity-form-submit-btn"
                >
                  Add Activity
                </Button>
              </div>
        ...
        <>
          <Form.Group>
            <Form.Label htmlFor="activityNameFull">Name</Form.Label>
            <Form.Control
              id="activityNameFull"
              type="text"
              value={name}
          ...
          <div>
            <Form.Group>
              <Form.Label htmlFor="activityDescription">Description</Form.Label>
              <Form.Control
            ...
            <Form.Group className="mb-3">
              <Form.Label htmlFor="activityColor">Color</Form.Label>
              <Dropdown>
                <Dropdown.Toggle 
