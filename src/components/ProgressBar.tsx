...
export default function ProgressBar({
  ...
  function calculateProgressColor(progressPercentage: number): string {
    ...
    const timeRatio = progressPercentage / 100;
    ...
    if (timeRatio < 0.5) {
      ...
      return `hsl(${Math.round(hue)}, ${DEFAULT_SATURATION}, ${DEFAULT_LIGHTNESS})`;
